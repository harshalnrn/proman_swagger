...
public class UserAuthTokenEntity implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(name = "USER_ID")//Foreign key column , that takes primary key value of user object
    private UserEntity user;  //Association with child //authentication values belongs to single user. But single user can have multiple tokens
