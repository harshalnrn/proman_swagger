...
@NamedQueries(
        {
                ...
                @NamedQuery(name="userByPasword",query="select u from UserEntity u where u.email=:username and u.password=:encrypPassword")
...
//why no birectional mapping with UserAuthTokenEntity
