...
public class SignUpController {
  ...
  public ResponseEntity<SignupUserResponse> signup(final SignupUserRequest signupUserRequest) {
    ...
    return new ResponseEntity<SignupUserResponse>(
        signupUserResponse,
        HttpStatus.CREATED); // here we populate response entity using response model
    // note the signupUserResponse is the response model in line with the contract, and HttpStatus
    // belongs to Http packages
  }
}
